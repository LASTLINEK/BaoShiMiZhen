...
QT_MOC_LITERAL(3, 18, 20), // "on_BtnCancel_clicked"
QT_MOC_LITERAL(4, 39, 21) // "on_BtnConfirm_clicked"

    },
    "Setting\0sendData\0\0on_BtnCancel_clicked\0"
...
void Setting::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Setting::sendData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Setting::sendData(QString _t1)
{
