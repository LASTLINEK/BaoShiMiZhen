...
void UI::initRowBeta(Icon*** icons)//@clh �޸ĳ�ʼ�������޺���combo
{
    srand((int)time(NULL));
    int newkind;
    for (int i = 0; i < 10; i++){
...
void UI::initColumnBeta(Icon*** icons)//@clh �޸ĳ�ʼ������������combo
{
    srand((int)time(NULL));
    int newkind;
    for (int i = 0; i < 8; i++){
...
void UI::swap(int row1, int column1, int row2, int column2) {
    ...
    if (helper.IsValid(icons, 10, 10)) {
		std::vector<Icon*> result1 = getPoints(row1, column1);  //���ý����Ժ�(row1,col1)�Ŀ�������
		std::vector<Icon*> result2 = getPoints(row2, column2);  //���ý����Ժ�(row2,col2)�Ŀ�������
